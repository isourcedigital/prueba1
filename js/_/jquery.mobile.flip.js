...
//    return $flipShadow;
    ...
    Plugin.prototype.flipPrev = function() {
        ...
        $(document).on("vclick", ".lastest", function() {
            console.log('click');
        });
    ...
    Plugin.prototype.initPager = function() {
        ...
        var height = $elem.height();
        //PERCENT height
        var percenth = 100 * height / height;
        var heightCSS = (percenth - PAGER_HEIGHT) + '%';
        ...
        //console.log('flipPageCount' + flipPageCount);

        $elem.append($('<div class="pager"><div class="lastest">Latest</div><div class="pagerInner"></div><div class="oldest">Oldest</div></div>'));




        var $pager = $elem.children('.pager').children('.pagerInner');
...
//    }
    ...
    Plugin.prototype.init = function() {
        ...
        if (heightCSS === '') {
            ...
            heightCSS = parentHeight - $elem.offset().top + '%';
        }
