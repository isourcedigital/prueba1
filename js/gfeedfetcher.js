...
gfeedfetcher.prototype._displayresult = function(feeds) {
    ...
    for (var i = 0; i < feeds.length; i++) {
        ...
        var itemlabel = /label/i.test(this.showoptions) ? '<span class="labelfield">[' + this.feeds[i].ddlabel["name"] + ']</span>' : " "
        ...
        var itemImage = feeds[i].content.match(/<img.+src=[\'"]([^\'"]+)[\'"].*>/i);
        /*
         if(itemImage){
         itemImage=itemImage[1];
         rssoutput+=this.itemcontainer + itemtitle + " " + itemlabel + " " + itemdate + "<br><img src='"+itemImage+"' width='450' height='250'>\n" + itemdescription + this.itemcontainer.replace("<", "</") + "\n\n"
         }else{
         rssoutput+=this.itemcontainer + itemtitle + " " + itemlabel + " " + itemdate + "\n" + itemdescription + this.itemcontainer.replace("<", "</") + "\n\n"
         }
         */
        //rssoutput+=this.itemcontainer + itemtitle + " " + itemlabel + " " + itemdate + "<br><img src='"+this.feeds[i].ddlabel["img"]+"' width='450' height='250'>\n" + itemdescription + this.itemcontainer.replace("<", "</") + "\n\n"
...
//var blogBox = $(document).find('.box'); 
//console.log('firstNote: '+ blogBox);
